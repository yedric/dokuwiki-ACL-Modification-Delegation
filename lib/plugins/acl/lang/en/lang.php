...
// line modified for ACLMOD v1.1
$lang['p_include']    = 'Higher permissions include lower ones. Create, Upload, Delete, and ACLMOD permissions only apply to namespaces, not pages.';
// line added for ACLMOD v1.1
$lang['p_denied']     = 'Only admin users may modify ACLs with ACLmod permissions set.';
